...
2. Run `sonar-watch` from a terminal
	1. If you cloned the repo instead of using pip install, double-click `watch_clipboard.py` or run `python watch_clipboard.py`.
